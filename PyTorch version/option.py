...
parser.add_argument('--bn', action='store_true', help='use bn in residual block')
parser.add_argument('--slim_num', type=int, default=1, help='divide the network into {slim_part} parts')
parser.add_argument('--full_width_mult', type=float, default=1, help='set full width mult')
parser.add_argument('--batch_test', action='store_true', help='test a batch')
parser.add_argument('--print_each', action='store_true', help='print result of every sample')
parser.add_argument('--model_stat', action='store_true', help='count model params and flops')

parser.add_argument('--content_loss_factor', type=float, default=1e-1, help='content loss factor')
parser.add_argument('--feature_loss_factor', type=float, default=1, help='feature loss factor')
parser.add_argument('--adversarial_loss_factor', type=float, default=5e-3, help='adversarial loss factor')
